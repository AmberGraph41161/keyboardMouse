...
keyboardMouse: build/main.o build/xdg-shell.o build/wlr-layer-shell-unstable-v1.o build/wlr-screencopy-unstable-v1.o build/wlr-virtual-pointer-unstable-v1.o build/xdg-output-unstable-v1.o
